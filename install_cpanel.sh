...
curl -sk "https://127.0.0.1:2087/$SESS_TOKEN/scripts/doconfigurenameserver?nameserver=bind" --cookie $COOKIE_FILE

# REMOVE COOKIE
rm -f $CWD/sltwhmcookie.txt
...
echo "Actualizando a MariaDB 10.3..."
